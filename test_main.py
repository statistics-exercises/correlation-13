...
class UnitTests(unittest.TestCase) :
      def test_plot(self) :
          ...
          for i in range(len(this_x)) :
              ...
              self.assertTrue( this_y[i]<np.sin(4*this_x[i])+0.1 and this_y[i]>np.sin(4*this_x[i])-0.1, "One or more of your coordinates falls outside of the region of interest" )
